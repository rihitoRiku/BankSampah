  ...
  const submitLoginHandler = async () => {
    ...
    try {
      ...
      setUserData({
        ...
        role: data.data.role,
        nama: data.data.nama,
        noRumah: data.data.noRumah,
        tabungan: data.data.tabungan,
        setoran: data.data.setoran,
      });
      ...
      localStorage.setItem("noRumah", data.data.noRumah);
      localStorage.setItem("tabungan", data.data.tabungan.toString());

      // Redirect to /nasabah page after successful login
      router.push("/nasabah");
      ...
      <div className="min-h-screen bg-gray-50 text-gray-900 dark:text-gray-100 flex items-center gap-6 lg:gap-16">
        ...
        <div className="max-w-screen-md min-h-screen pe-8 flex flex-col justify-between">
          ...
          <div className="">
            ...
            >
              Join us in transforming waste into value. At Bank Sampah, we are
              on a mission to create a cleaner environment by turning recyclable
              waste into opportunities. Together, we can make a difference by
              responsibly managing our waste and building a greener future for
              our community.
            </p>
            <button
